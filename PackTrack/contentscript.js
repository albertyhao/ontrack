  ...
  if (!whitelist){
    ...
    chrome.runtime.sendMessage(chrome.runtime.id, {txt: siteText}, function(response) {
      ...
      if (response.res && whitelist.every(function(site){return site !== location.hostname}) ) {
        ...
        document.body.innerHTML = `<center><p style="color:white; padding-top: 10vh; font-family: Verdana, Geneva, Tahoma, sans-serif; font-size: 3.25rem">It seems as if you are distracted!</p><br><br><br><p>${response.sim}</p></center>`;
      }
